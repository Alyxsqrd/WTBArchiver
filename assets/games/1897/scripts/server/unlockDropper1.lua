...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local dropperPartsName = "Tycoon"..tycoonid.."Dropper1Part"
            local dropperParts = GetObjectsByName(dropperPartsName)
            local dropperSpawnerName = "Tycoon"..tycoonid.."Dropper1Spawner"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "UnlockStarterText"
