...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local upgradePartsName = "Tycoon"..tycoonid.."SafeDoor"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "Decor2Text"
