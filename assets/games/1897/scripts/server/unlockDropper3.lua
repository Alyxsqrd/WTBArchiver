...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local dropperPartsName = "Tycoon"..tycoonid.."Dropper3Part"
            local dropperParts = GetObjectsByName(dropperPartsName)
            local dropperSpawnerName = "Tycoon"..tycoonid.."Dropper3Spawner"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "Unlock2Text"
