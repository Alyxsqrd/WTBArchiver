...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local upgradePartsName = "Tycoon"..tycoonid.."Railing3Part"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "Decor7Text"
