...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local dropperPartsName = "Tycoon"..tycoonid.."Dropper4Part"
            local dropperParts = GetObjectsByName(dropperPartsName)
            local dropperSpawnerName = "Tycoon"..tycoonid.."Dropper4Spawner"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "Unlock3Text"
