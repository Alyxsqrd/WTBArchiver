...
function OnTouchBegin(touched)
    ...
    if (object.renderer.visible == true) then
        if purchased == false then 
            ...
            local upgradePartsName = "Tycoon"..tycoonid.."Stairs1Part"
            ...
            local upgradeTextName = "Tycoon" .. tycoonid .. "Decor3Text"
